...
<template>
    <div class="my-component">
        ...
        <slot></slot>
        <div v-if="currentPage != 'Profile/ChatPrivateView'" class="fixed z-50 w-full h-16 max-w-xl -translate-x-1/2 border rounded-md border-blue-200    bottom-0 left-1/2  flex justify-between items-center p-4 bg-white
