...
<template>
    ...
    <nav class="flex justify-between items-center p-4 bg-slate-200 text-slate-800">
        ...
        <template v-if="loginUser.id !== null && currentPage === 'ProfileView'">
            <li>
                ...
                <svg class="w-7 h-6  text-gray-500 group-hover:text-blue-600 " aria-hidden="true" fill="currentColor"
                    xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 28 28">
    ...
    <div
        ...
        <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
            ...
            <svg class="w-5 h-5 mb-1 text-gray-500  group-hover:text-blue-600 " fill="currentColor"
            ...
            <Link title="Mis Series" href="/misSeries" data-tooltip-target="tooltip-settings"
                class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50  group">
            <svg class="w-7 h-7 mb-1 text-gray-500  group-hover:text-blue-600 " aria-hidden="true" fill="currentColor"
            ...
            <Link title="Mi Perfil" :href="`/perfil/${loginUser.id}`" data-tooltip-target="tooltip-profile"
