...
<template>
    ...
    <nav
        ...
        <div v-if="!loading" class="flex items-center gap-6">
            ...
            <Link href="/" class="text-xl"><img src="/public/images/ImagotipoEspesorApilado.svg" alt="Isotipo-TVON"
                class="block h-auto w-16">
            <svg xmlns="http://www.w3.org/2000/svg" id="Capa_1" data-name="Capa 1" viewBox="0 0 118.16 85.2">
                ...
                <text class="cls-2" transform="translate(65.35 31.55)">
                    <tspan class="cls-1 dark:fill-white">
