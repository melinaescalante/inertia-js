...
<template>
    <div class="m-2">
      ...
      <svg aria-hidden="true" class="inset-y-0 start-0 flex items-center ps-3 pt-4 pointer-events-none absolute w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
