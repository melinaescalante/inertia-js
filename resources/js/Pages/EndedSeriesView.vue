                        ...
                        <div class="flex flex-col gap-2 mt-2 skiptranslate">
                            ...
                            <div class="flex gap-2 items-center">
                                ...
                                <p>Puntuación: <span class="font-medium"
                                    ...
                                    <svg v-if="series[index].rate" class="w-5 h-5 me-5 text-yellow-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="flex">
                                <Link :href="`puntuarSerie/${serie.name}/${serie.id}`" class="mt-3 text-blue-1000 bg-blue-0 hover:bg-blue-200 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5  focus:outline-none">{{series[index].rate?'Puntear devuelta': 'Puntear'}}</Link>
                            </div>
                    </div>
                    </Link>
                </li>
