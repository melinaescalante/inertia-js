    ...
    <section class="mt-20">
        ...
        <div v-if="!loading" v-for="(serie) in series"
            ...
            <div>
                ...
                <img class="w-[3rem] h-10 rounded-full" :src="serie.urlImage || '/noimage.png'"
                :alt="`Portada de la serie ${serie.idSerie}`">
            </div>
            <div class="flex gap-1 justify-between font-medium w-full">
                ...
                <div class="flex gap-1 items-center">
                    ...
                    <svg v-if="serie.rate" class="w-5 h-5 me-5 text-yellow-400" aria-hidden="true"
