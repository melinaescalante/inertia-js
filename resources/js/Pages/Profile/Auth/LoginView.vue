        ...
        <form action="#" @submit.prevent="handleSubmit" class="p-3">
            ...
            <div class="mb-6">
                ...
                <div class="flex gap-1">
                    ...
                    <button type="button" @click="showPassword" class="bg-blue-1000 rounded-lg"><svg class="w-6 h-6 text-orange-0 fill-transparent " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
