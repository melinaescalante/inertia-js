...
<template>
    ...
    <div class="flex flex-col gap-3 m-4">
        ...
        {{  console.log(seriesToWatch.value)}}
        <img class="object-cover  rounded-t-lg w-28    md:rounded-none md:rounded-s-lg"
        src="/public/noimage.png" alt="">
        <div class="flex flex-col justify-between p-4 leading-normal">
                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Tu lista </p>
